package com.xingguang.localrun.push;
...
import com.xingguang.localrun.utils.SystemUtils;
...
//        String text = resultInfo[0];
        ...
        if (SystemUtils.isAppAlive(context, AppUtil.getPackageName(context))) {
            new ShowNotification().showIsAppLive(context, context.getResources().getString(com.xingguang.localrun.R.string.app_name),
            ...
            new ShowNotification().showIsNotApplive(context, context.getResources().getString(com.xingguang.localrun.R.string.app_name),
                    notificationNum, data, "", "",
                    "", "");
            return false;
