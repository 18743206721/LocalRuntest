...
public class Startwo extends View {
    //星星评分
    ...
    public Startwo(Context mContext, AttributeSet attrs) {
        super(mContext, attrs);
        init(mContext, attrs);
    }

    public Startwo(Context mContext, AttributeSet attrs, int defStyleAttr) {
