...
import com.xingguang.localrun.wheel.XmlParserHandler;
import com.xingguang.localrun.wheel.model.CityModel;
import com.xingguang.localrun.wheel.model.DistrictModel;
import com.xingguang.localrun.wheel.model.ProvinceModel;
...
public class AddAddressPopUpWindow extends PopupWindow implements
    ...
    private String province, city, district, from;
    ...
    public AddAddressPopUpWindow(Context context, View parent, String province,
                                 String city, String district, boolean districtHide, String froms) {
...
//                    msg.what = 1;
//                } else if (context == AddCrowdFundingActivity.instance) {
//                    msg = AddCrowdFundingActivity.instance.handler.obtainMessage();
//                    msg.what = 1;
//                } else if (context == MyResumeActivity.instance) {
//                    msg = MyResumeActivity.instance.mHandler.obtainMessage();
//                    msg.what = Integer.parseInt(from);
//                } else if (context == SendHiringMessageActivity.instance) {
//                    msg = SendHiringMessageActivity.instance.mHandler.obtainMessage();
//                    msg.what = Integer.parseInt(from);
//                } else if (context == SearchResumeActivity.instance) {
//                    msg = SearchResumeActivity.instance.handler.obtainMessage();
//                    msg.what = Integer.parseInt(from);
//                }
...
//                    Message msgs = HiringMessageActivity.instance.handler.obtainMessage();
//                    msgs.what = 2;
//                    msgs.sendToTarget();
//                }
//                if (context == SearchResumeActivity.instance) {
//                    Message msgs = SearchResumeActivity.instance.handler.obtainMessage();
//                    msgs.what = 2;
//                    msgs.sendToTarget();
//                }
                dismiss();
