 ...
 * 作者:LiuYu
 */
public class SearchTwoAdapter extends RecyclerView.Adapter<CommonViewHolder> {

    private Context mContext;
    private List<SearchTwoBean.DataBeanX.DataBean> list;
    ...
    public SearchTwoAdapter(Context mContext, List<SearchTwoBean.DataBeanX.DataBean> list) {
    ...
    public void setList(List<SearchTwoBean.DataBeanX.DataBean> list) {
        this.list = list;
