 ...
 * 作者:LiuYu
 */
public class SearchThreeAdapter extends RecyclerView.Adapter <CommonViewHolder> {

    private Context mContext;
    private List<Searchthreebean.DataBeanX.DataBean> list;
    private OnItemClickLitener mOnItemClickLitener;

    public void setList(List<Searchthreebean.DataBeanX.DataBean> list) {
        this.list = list;
    ...
    public SearchThreeAdapter(Context mContext, List<Searchthreebean.DataBeanX.DataBean> list) {
