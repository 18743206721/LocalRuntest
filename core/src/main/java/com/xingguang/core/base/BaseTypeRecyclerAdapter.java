...
/**
 * RecyclerView type BaseAdapter (用于需区分type的场合)
 *
 * @param <T> 数据类型
 */
public abstract class BaseTypeRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
//
//        if (viewHolder instanceof BaseTypeRecyclerAdapter.Holder)
